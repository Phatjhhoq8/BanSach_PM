<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhMucSanPhamCT.ascx.cs" Inherits="BanSachTest.UserUI.DanhMucSanPhamCT" %>
<!-- show products -->
    <div class="container mx-auto mb-4">
      <!-- best-selling -->
      <div class="bg-white mt-4">
        <!-- heading -->
        <div class="py-3 px-6 bg-gradient-to-l from-secondary-500 to-primary-600"><h2 class="uppercase text-white font-semibold text-lg"><asp:Label ID="lblTenDanhMuc" runat="server"></asp:Label> </h2></div>
        ...
        <div id="swiper-trend" class="swiper mySwiper pt-5">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide hover:shadow-xl h-auto">
              <!-- thumbnail -->
              <div class="p-1"><img class="w-full h-auto" src='<%="./img/products/trending/"+listSPDM[i].HinhAnh %>' alt="trending" /></div>
              <!-- infomation: title - price - price old -->
              <div class="p-2">
                <a class="text-sm block line-clamp-2" href='<%="ChiTietSach.aspx?IdSach=" + listSPDM[i].IdSanPham.ToString() %>'><%=listSPDM[i].TenSach %></a>
                <div class="mt-1 text-base text-primary-700"><%=listSPDM[i].Gia.ToString() %></div>
