<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChiTietSachCT.ascx.cs" Inherits="BanSachTest.UserUI.ChiTietSachCT" %>
<div class="container mx-auto mb-4">
      <!-- best-selling -->
      <div class="bg-white mt-4">
        <!-- heading -->
        <div class="py-3 px-6 bg-gradient-to-l from-secondary-500 to-primary-600"><h2 class="uppercase text-white font-semibold text-lg">Chi tiết sách</h2></div>
        ...
        <div id="swiper-trend" class="swiper mySwiper pt-5">
          <div style="text-align:center">
            ...
            <div >
              <!-- thumbnail -->
              <div class="p-1"><img class="w-full h-auto" src='<%="./img/products/trending/" + infoSach.HinhAnh %>' alt="trending" /></div>
              <!-- infomation: title - price - price old -->
              <div class="p-2">
                <a class="text-sm block line-clamp-2" href="#"><%=infoSach.TenSach %></a>
                <div class="mt-1 text-base text-primary-700"><%=infoSach.Gia.ToString() %></div>
      ...
      <div class="bg-white mt-4">
        <!-- heading -->
        <div class="py-3 px-6 bg-gradient-to-l from-secondary-500 to-primary-600"><h2 class="uppercase text-white font-semibold text-lg">Sách cùng danh mục</h2></div>
        <!-- wrapper - inner products -->
