                    ...
                    <ItemTemplate>
                        <div class="group flex flex-col bg-white">
                            ...
                            <a href='ChiTiet.aspx?id=<%# Eval("MaSP") %>' class="block relative aspect-w-3 aspect-h-4 bg-transparent overflow-hidden mb-3">
                                <img src='<%# "img/books/" + Eval("HinhAnh") %>' onerror="this.src='https://placehold.co/400x550/FFF/333?text=Book';" alt='<%# Eval("TenSP") %>' class="w-full h-full object-contain mix-blend-multiply drop-shadow-md group-hover:scale-105 transition-transform duration-300"/>
                            ...
                            <div class="flex flex-col flex-1 pl-1">
                                ...
                                <div class="flex items-center gap-2 mt-auto">
                                    <span class="text-sm font-bold text-primary"><%# string.Format("{0:N0}đ", Eval("Gia")) %></span>
