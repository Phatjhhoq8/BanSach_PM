...
public partial class Admin_Analytics : System.Web.UI.Page
{
    ...
    private void LoadAnalytics()
    {
        ...
        {
            conn.Open();
            litRevenue.Text = Money(Scalar(conn, "SELECT ISNULL(SUM(TongTien), 0) FROM dbo.DonHang WHERE TrangThai <> 4"));
            ...
            Bind(rptTopProducts, conn, @"
                ...
                FROM dbo.ChiTietDonHang ct JOIN dbo.SanPham sp ON sp.MaSP = ct.MaSP
