<%@ Page Title="Cấu hình hệ thống - BanSach Premium" Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true" CodeFile="Settings.aspx.cs" Inherits="Admin_Settings" %>
    ...
    <div class="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <section class="glass-card rounded-[32px] p-8">
            ...
            <div class="space-y-4 text-sm text-slate-300">
                ...
                <div class="flex items-center justify-between border-b border-white/5 pb-4"><span>Chuyển khoản ngân hàng</span><span class="rounded-full bg-amber-500/10 px-3 py-1 font-bold text-amber-400">Bảo trì</span></div>
